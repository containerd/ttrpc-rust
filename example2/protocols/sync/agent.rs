...
impl ::ttrpc::MethodHandler for ExecProcessMethod {
    fn handler(
        ...
        ::ttrpc::request_handler!(self, ctx, req, ExecProcessRequest, exec_process);
        Ok(())
    }
}
...
impl ::ttrpc::MethodHandler for SignalProcessMethod {
    fn handler(
        ...
        ::ttrpc::request_handler!(self, ctx, req, SignalProcessRequest, signal_process);
        Ok(())
    }
}
...
impl ::ttrpc::MethodHandler for WaitProcessMethod {
    fn handler(
        ...
        ::ttrpc::request_handler!(self, ctx, req, WaitProcessRequest, wait_process);
        Ok(())
    }
}
...
impl ::ttrpc::MethodHandler for ListProcessesMethod {
    fn handler(
        ...
        ::ttrpc::request_handler!(self, ctx, req, ListProcessesRequest, list_processes);
        Ok(())
    }
}
...
impl ::ttrpc::MethodHandler for WriteStdinMethod {
    fn handler(
        ...
        ::ttrpc::request_handler!(self, ctx, req, WriteStreamRequest, write_stdin);
        Ok(())
    }
}
...
impl ::ttrpc::MethodHandler for ReadStdoutMethod {
    fn handler(
        ...
        ::ttrpc::request_handler!(self, ctx, req, ReadStreamRequest, read_stdout);
        Ok(())
    }
}
...
impl ::ttrpc::MethodHandler for ReadStderrMethod {
    fn handler(
        ...
        ::ttrpc::request_handler!(self, ctx, req, ReadStreamRequest, read_stderr);
        Ok(())
    }
}
...
impl ::ttrpc::MethodHandler for CloseStdinMethod {
    fn handler(
        ...
        ::ttrpc::request_handler!(self, ctx, req, CloseStdinRequest, close_stdin);
        Ok(())
    }
}
...
impl ::ttrpc::MethodHandler for TtyWinResizeMethod {
    fn handler(
        ...
        ::ttrpc::request_handler!(self, ctx, req, TtyWinResizeRequest, tty_win_resize);
        Ok(())
    }
}
...
impl ::ttrpc::MethodHandler for UpdateRoutesMethod {
    fn handler(
        ...
        ::ttrpc::request_handler!(self, ctx, req, UpdateRoutesRequest, update_routes);
        Ok(())
    }
}
...
impl ::ttrpc::MethodHandler for ListRoutesMethod {
    fn handler(
        ...
        ::ttrpc::request_handler!(self, ctx, req, ListRoutesRequest, list_routes);
        Ok(())
    }
}
...
impl ::ttrpc::MethodHandler for StartTracingMethod {
    fn handler(
        ...
        ::ttrpc::request_handler!(self, ctx, req, StartTracingRequest, start_tracing);
        Ok(())
    }
}
...
impl ::ttrpc::MethodHandler for StopTracingMethod {
    fn handler(
        ...
        ::ttrpc::request_handler!(self, ctx, req, StopTracingRequest, stop_tracing);
        Ok(())
    }
}
...
impl ::ttrpc::MethodHandler for CreateSandboxMethod {
    fn handler(
        ...
        ::ttrpc::request_handler!(self, ctx, req, CreateSandboxRequest, create_sandbox);
        Ok(())
    }
}
...
impl ::ttrpc::MethodHandler for OnlineCpuMemMethod {
    fn handler(
        ...
        ::ttrpc::request_handler!(self, ctx, req, OnlineCpuMemRequest, online_cpu_mem);
        Ok(())
    }
}
...
impl ::ttrpc::MethodHandler for CopyFileMethod {
    fn handler(
        ...
        ::ttrpc::request_handler!(self, ctx, req, CopyFileRequest, copy_file);
        Ok(())
    }
}
pub fn create_agent_service(
    ...
    methods
        .insert(
            "/agent.AgentService/CreateContainer".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/StartContainer".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/RemoveContainer".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/ExecProcess".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/SignalProcess".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/WaitProcess".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/ListProcesses".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/UpdateContainer".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/StatsContainer".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/PauseContainer".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/ResumeContainer".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/WriteStdin".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/ReadStdout".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/ReadStderr".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/CloseStdin".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/TtyWinResize".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/UpdateInterface".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/UpdateRoutes".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/ListInterfaces".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/ListRoutes".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/StartTracing".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/StopTracing".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/CreateSandbox".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/DestroySandbox".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/OnlineCPUMem".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/ReseedRandomDev".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/GetGuestDetails".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/MemHotplugByProbe".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/SetGuestDateTime".to_string(),
    ...
    methods
        .insert(
            "/agent.AgentService/CopyFile".to_string(),
...
impl AgentServiceClient {
    ...
    pub fn copy_file(
        ...
        let mut cres = super::google::protobuf::Empty::default();
        ::ttrpc::client_request!(self, ctx, req, "agent.AgentService", "CopyFile", cres);
        Ok(cres)
    }
}
